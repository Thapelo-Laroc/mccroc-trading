    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="{{ route('calender') }}" class="navbar-brand mx-4 mb-3">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('calender') }}" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Calender</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bord text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Economic Calender</h6>
                    </div>
                    <div class="table-responsive">
                        ...
                        "countryFilter": "us,eu,gb,za,cn,jp"
                        }
                        </script>
                        </div>
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="https://mokoena.vercel.app">Thapelo Mokoena</a>
                        </div>
                    </div>
                </div>
            </div>
