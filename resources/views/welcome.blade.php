...
<!-- Function used to shrink nav bar removing paddings and adding black background -->
    ...
    <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            <div class="inline-block br-round bg-indigo-30 indigo-lightest p-2 fs-s2 mb-5">
                <div class="inline-block br-round px-3 py-1 mr-3 fs-s3" style="background-color: var(--red);">Youth In Forex</div>
                Taking Over Mbombela.
            </div>
            <div>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">McCroc Trading <br />Forex Journey</h1>
    ...
    <!-- slider -->
    <section class="relative" style="background-color: var(--black); border: 3px white;">
        <div id="slider-1">
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="white fs-l3 fw-900">McCrocs' Trading Strategy</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">We use a combination of Indicators, Fundamental Analysis and Technical Analysis in our strategy</p>
    ...
    <section class="p-10 md-py-10">
        <div class="w-100pc md-w-70pc mx-auto py-10" style="text-align:center">
            <h3 class="white ">
                These Strategies are combined to provide high <span class="border-b bc-indigo bw-4"> probability</span> trade entries.</h3>
        </div>
    </section>
        ...
        <div class="flex flex-column md-flex-row md-w-80pc mx-auto">
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10 pointer hover-scale-up-1 ease-300">
                    <div class="inline-block br-3 px-4 py-1 mb-10 fs-s4 uppercase" style="background-color: var(--red); color:white">
                        Buy-side</div>
                    <div class="indigo-lightest fw-600 fs-m1">Buy-side forex trading strategy <span class="opacity-30">involves purchasing currencies with the anticipation 
                        that their value will increase over time, aiming to profit from the appreciation.</span> </div>
            ...
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10  pointer hover-scale-up-1 ease-300">
                    <div class="inline-block br-3 px-4 py-1 mb-10 fs-s4 uppercase" style="background-color: var(--red); color:white">
                    Sell-Side</div>
                    <div class="indigo-lightest fw-600 fs-m1">sell-side forex trading strategy <span class="opacity-30">involves selling currencies with the expectation that their value will decrease, 
                        aiming to profit from the depreciation or short-term fluctuations in the market.</span> </div>
                    <a href="#" class="mt-10 button bg-black fs-s3 white no-underline">Read</a>
        ...
        <div class="p-10 flex flex-wrap">
            ...
            <div class="w-100pc md-w-25pc">
                <div class="m-3 p-5 br-8 bg-indigo-lightest-10 overflow-hidden">
                    <div class="p-3">
                        ...
                        <div class="white flex items-center">R<span class="fs-l5 lh-1">0</span>/mo</div>
                    </div>
                    <div class="p-3 indigo-lightest fw-400 fs-s1 lh-5">
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Platform Access</span>
                        </div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Educational Content</span>
                        </div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Trading Advice</span>
                        </div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Trading Strategy</span>
                        </div>
            ...
            <div class="w-100pc md-w-25pc">
                <div class="m-3 p-5 br-8 bg-white overflow-hidden">
                    <div class="p-3">
                        <h3 class="indigo">Paid</h3>
                        <div class="black flex items-center">R<span class="fs-l5 lh-1">150</span>/mo</div>
                    </div>
                    <div class="p-3 black fw-400 fs-s1 lh-5">
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Online Class </span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Monthly Signals</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50"></span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
